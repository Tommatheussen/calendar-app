...
"use strict";!function(){function o(o){function t(){o.showHelp=!0}var e=this;e.openHelp=t}o.$inject=["$rootScope"],angular.module("footer").component("footer",{templateUrl:"footer/footer.tmpl.html",controller:o,controllerAs:"vm"})}();
...
"use strict";!function(){function t(t,e,n,a,s,i,r,o,f){function l(){var t=new Date;m.offsetDays=D(t.getMonth(),t.getUTCFullYear()),m.days=v(t.getMonth(),t.getUTCFullYear());var e=new Date(t.getFullYear(),t.getMonth(),1).toISOString(),n=new Date(t.getFullYear(),t.getMonth()+1,0).toISOString();a.getPreviousEvents(e,n).then(function(t){y=t,h()}),a.getShifts().then(function(t){m.shifts=t})}function h(){m.days.map(function(t){var e=r("amDateFormat")(t.date,"DD-MM-YYYY");t.shift=y[e]?y[e].shift:null})}function c(t){return new Array(t)}function u(t,e){var n=new Date(t);return n.setHours(e.hour),n.setMinutes(e.minute),{dateTime:n}}function d(t){var e,a={calendarId:i},s=r("amDateFormat")(t.date,"DD-MM-YYYY");t.shift&&!y[s]?(e="insert",a.start=u(t.date,m.shifts[t.shift].start),a.end=u(t.date,m.shifts[t.shift].end),a.summary=t.shift):t.shift&&y[s]&&y[s].shift!==t.shift?(e="update",a.eventId=y[s].id,a.start=u(t.date,m.shifts[t.shift].start),a.end=u(t.date,m.shifts[t.shift].end),a.summary=t.shift):!t.shift&&y[s]&&(e="delete",a.eventId=y[s].id);var o=e?n.createRequest("calendar",Y[e],a):null;return o}function g(){var t=[];if(m.days.forEach(function(e){var n=d(e);n&&t.push(n)},this),t.length>0){for(var e=s.gapi.client.newBatch(),n=0;n<t.length;n++)e.add(t[n]);e.then(function(t){m.days.forEach(function(t){var e=r("amDateFormat")(t.date,"DD-MM-YYYY");y[e]=t.shift},this);var e=o.alert().title("Update success").textContent("De shiften zijn succesvol opgeslagen in Google Calendar.").ok("Super!");o.show(e)},function(t){console.log(t)},this)}}function v(t,e){for(var n=new Date(e,t,1),a=[];n.getMonth()===t;)a.push({date:new Date(n.toString())}),n.setDate(n.getDate()+1);return a}function D(t,e){var n=new Date(e,t,1),a=(n.getDay()||7)-1;return a}var m=this;m.$onInit=l,m.saveShifts=g,m.getRange=c;var p;f.$on("help:opened",function(){p=angular.copy(m.days[9-m.offsetDays].shift),m.days[9-m.offsetDays].shift="klv"}),f.$on("help:closed",function(){m.days[9-m.offsetDays].shift=p});var y={},Y={insert:"events.insert",delete:"events.delete",update:"events.patch"};m.smallScreen=t("xs"),e.$watch(function(){return t("xs")},function(t){m.smallScreen=t}),m.setShift=function(t,e){t.shift===e?t.shift=null:t.shift=e}}t.$inject=["$mdMedia","$scope","GApi","calendarService","$window","calendarId","$filter","$mdDialog","$rootScope"],angular.module("calendar").component("calendar",{templateUrl:"calendar/calendar.tmpl.html",controller:t,controllerAs:"vm",bindings:{flex:"="}})}();
"use strict";!function(){angular.module("calendarApp",["ngMaterial","calendar","login","topToolbar","footer","ui.router","angular-google-gapi","angulartics","angulartics.google.analytics","angularMoment","angularHelpOverlay"])}();
