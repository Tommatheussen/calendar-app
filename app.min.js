...
"use strict";angular.module("calendar").factory("calendarService",["$http",function(n){function t(){function t(n){return console.log(n),n.data}return n.get("shifts.json").then(t).catch(c)}function e(){}function c(n){console.log(n)}return{getShifts:t,getCalendar:e}}]);
"use strict";angular.module("calendar").config(["$stateProvider",function(a){var e={name:"calendar",url:"/",component:"calendar"};a.state(e)}]);
"use strict";function calendarController(e,n,t,a){function o(){t.executeAuth("calendar","calendarList.list").then(function(e){c.calendars=e.items},function(e){console.log(e)}),a.getShifts().then(function(e){c.shifts=e})}function l(){t.executeAuth("calendar","events.insert",{calendarId:"hj3i0ucmkenfjmdbrr85v7o2q8@group.calendar.google.com",start:{dateTime:new Date},end:{dateTime:new Date((new Date).setHours("15"))}}).then(function(e){console.log(e)},function(e){console.log(e)})}function r(e,n){for(var t=new Date(n,e,1),a=[],o=(t.getDay()||7)-1,l=0;l<o;l++)a.push({offset:!0});for(;t.getMonth()===e;)a.push({date:new Date(t.toString())}),t.setDate(t.getDate()+1);return a}var c=this;c.$onInit=o,c.saveShifts=l,c.days=r((new Date).getMonth()-1,(new Date).getFullYear()),c.smallScreen=e("xs"),n.$watch(function(){return e("xs")},function(e){c.smallScreen=e}),c.setShift=function(e,n){console.log(e,n),e.shift===n?e.shift=null:e.shift=n}}calendarController.$inject=["$mdMedia","$scope","GApi","calendarService"],angular.module("calendar").component("calendar",{templateUrl:"calendar/calendar.tmpl.html",controller:calendarController,controllerAs:"vm",bindings:{flex:"="}});
"use strict";angular.module("calendarApp",["ngMaterial","calendar","login","topToolbar","ui.router","angular-google-gapi","angulartics","angulartics.google.analytics"]);
