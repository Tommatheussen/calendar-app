...
"use strict";!function(){function t(t,e,n,a,s,i,r,o){function f(){var t=new Date;m.offsetDays=v(t.getMonth(),t.getUTCFullYear()),m.days=g(t.getMonth(),t.getUTCFullYear());var e=new Date(t.getFullYear(),t.getMonth(),1).toISOString(),n=new Date(t.getFullYear(),t.getMonth()+1,1).toISOString();a.getPreviousEvents(e,n).then(function(t){D=t,l()}),a.getShifts().then(function(t){m.shifts=t})}function l(){m.days.map(function(t){var e=r("amDateFormat")(t.date,"DD-MM-YYYY");t.shift=D[e]?D[e].shift:null})}function u(t){return new Array(t)}function h(t,e){var n=new Date(t);return n.setHours(e.hour),n.setMinutes(e.minute),{dateTime:n}}function c(t){var e,a={calendarId:i},s=r("amDateFormat")(t.date,"DD-MM-YYYY");t.shift&&!D[s]?(e="insert",a.start=h(t.date,m.shifts[t.shift].start),a.end=h(t.date,m.shifts[t.shift].end),a.summary=t.shift):t.shift&&D[s]&&D[s].shift!==t.shift?(e="update",a.eventId=D[s].id,a.start=h(t.date,m.shifts[t.shift].start),a.end=h(t.date,m.shifts[t.shift].end),a.summary=t.shift):!t.shift&&D[s]&&(e="delete",a.eventId=D[s].id);var o=e?n.createRequest("calendar",Y[e],a):null;return o}function d(){var t=[];if(m.days.forEach(function(e){var n=c(e);n&&t.push(n)},this),t.length>0){for(var e=s.gapi.client.newBatch(),n=0;n<t.length;n++)e.add(t[n]);e.then(function(t){m.days.forEach(function(t){var e=r("amDateFormat")(t.date,"DD-MM-YYYY");D[e]=t.shift},this);var e=o.alert().title("Update success").textContent("De shiften zijn succesvol opgeslagen in Google Calendar.").ok("Super!");o.show(e)},function(t){console.log(t)},this)}}function g(t,e){for(var n=new Date(e,t,1),a=[];n.getMonth()===t;)a.push({date:new Date(n.toString())}),n.setDate(n.getDate()+1);return a}function v(t,e){var n=new Date(e,t,1),a=(n.getDay()||7)-1;return a}var m=this;m.$onInit=f,m.saveShifts=d,m.getRange=u;var D={},Y={insert:"events.insert",delete:"events.delete",update:"events.patch"};m.smallScreen=t("xs"),e.$watch(function(){return t("xs")},function(t){m.smallScreen=t}),m.setShift=function(t,e){t.shift===e?t.shift=null:t.shift=e}}t.$inject=["$mdMedia","$scope","GApi","calendarService","$window","calendarId","$filter","$mdDialog"],angular.module("calendar").component("calendar",{templateUrl:"calendar/calendar.tmpl.html",controller:t,controllerAs:"vm",bindings:{flex:"="}})}();
