...
angular.module("angularHelpOverlay",[]).directive("helpOverlay",["$document",function(a){var l=!1;return{restrict:"A",scope:{helpOverlay:"=",overlayStart:"&overlayStartCallback",overlayStop:"&overlayStopCallback"},link:function(r,t,e){a.on("chardinJs:start",function(a){angular.isFunction(r.overlayStart)&&r.overlayStart(a),r.helpOverlay===!1&&r.$apply(function(){l=!0,r.helpOverlay=!0})}),a.on("chardinJs:stop",function(a){angular.isFunction(r.overlayStop)&&r.overlayStop(a),r.helpOverlay===!0&&r.$apply(function(){l=!0,r.helpOverlay=!1})}),r.$watch("helpOverlay",function(a,r){a!==r&&(l===!0?l=!1:a===!0?$(t).chardinJs("start"):a===!1&&$(t).chardinJs("stop"))})}}}]);
