...
"use strict";!function(){function t(t,e,n,a,s,i,r,o){function f(){w.setMonth(w.getMonth()-1,1),l()}function h(){w.setMonth(w.getMonth()+1,1),l()}function u(){a.getShifts().then(function(t){p.shifts=t}),l()}function l(){p.offsetDays=M(w.getMonth(),w.getUTCFullYear()),p.days=D(w.getMonth(),w.getUTCFullYear());var t=new Date(w.getFullYear(),w.getMonth(),1).toISOString(),e=new Date(w.getFullYear(),w.getMonth()+1,1).toISOString();a.getPreviousEvents(t,e).then(function(t){Y=t,c()})}function c(){p.days.map(function(t){var e=r("amDateFormat")(t.date,"DD-MM-YYYY");t.shift=Y[e]?Y[e].shift:null})}function d(t){return new Array(t)}function g(t,e){var n=new Date(t);return n.setHours(e.hour),n.setMinutes(e.minute),{dateTime:n}}function v(t){var e,a={calendarId:i},s=r("amDateFormat")(t.date,"DD-MM-YYYY");t.shift&&!Y[s]?(e="insert",a.start=g(t.date,p.shifts[t.shift].start),a.end=g(t.date,p.shifts[t.shift].end),a.summary=t.shift):t.shift&&Y[s]&&Y[s].shift!==t.shift?(e="update",a.eventId=Y[s].id,a.start=g(t.date,p.shifts[t.shift].start),a.end=g(t.date,p.shifts[t.shift].end),a.summary=t.shift):!t.shift&&Y[s]&&(e="delete",a.eventId=Y[s].id);var o=e?n.createRequest("calendar",S[e],a):null;return o}function m(){var t=[];if(p.days.forEach(function(e){var n=v(e);n&&t.push(n)},this),t.length>0){for(var e=s.gapi.client.newBatch(),n=0;n<t.length;n++)e.add(t[n]);e.then(function(t){p.days.forEach(function(t){var e=r("amDateFormat")(t.date,"DD-MM-YYYY");Y[e]=t.shift},this);var e=o.alert().title("Update success").textContent("De shiften zijn succesvol opgeslagen in Google Calendar.").ok("Super!");o.show(e)},function(t){console.log(t)},this)}}function D(t,e){for(var n=new Date(e,t,1),a=[];n.getMonth()===t;)a.push({date:new Date(n.toString())}),n.setDate(n.getDate()+1);return a}function M(t,e){var n=new Date(e,t,1),a=(n.getDay()||7)-1;return a}var p=this;p.$onInit=u,p.saveShifts=m,p.getRange=d,p.prevMonth=f,p.nextMonth=h,p.today=new Date;var Y={},w=new Date,S={insert:"events.insert",delete:"events.delete",update:"events.patch"};p.smallScreen=t("xs"),e.$watch(function(){return t("xs")},function(t){p.smallScreen=t}),p.setShift=function(t,e){t.shift===e?t.shift=null:t.shift=e}}t.$inject=["$mdMedia","$scope","GApi","calendarService","$window","calendarId","$filter","$mdDialog"],angular.module("calendar").component("calendar",{templateUrl:"calendar/calendar.tmpl.html",controller:t,controllerAs:"vm",bindings:{flex:"="}})}();
